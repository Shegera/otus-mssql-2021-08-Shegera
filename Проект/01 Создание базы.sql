...
CREATE NONCLUSTERED INDEX IX_Employees_EmployeeID_FullName ON [Employees] (EmployeeID) INCLUDE (FullName)
...
CREATE NONCLUSTERED INDEX IX_Partners_OrganisationID_OrganisationName ON [Partners] (PartnerID) INCLUDE (PartnerName)
CREATE NONCLUSTERED INDEX IX_Partners_INN ON [Partners] (INN) INCLUDE (PartnerName, KPP)
...
('20210101', '20210401', '20210801', '20220101', '20220401', '20220801', '20230101');																																																									
GO
